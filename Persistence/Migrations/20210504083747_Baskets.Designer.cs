...
namespace Persistence.Migrations
{
    ...
    [Migration("20210504083747_Baskets")]
            ...
            modelBuilder.Entity("Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2021, 5, 4, 13, 7, 47, 65, DateTimeKind.Local).AddTicks(9662));
            ...
            modelBuilder.Entity("Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 4, 13, 7, 47, 81, DateTimeKind.Local).AddTicks(8633));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 4, 13, 7, 47, 82, DateTimeKind.Local).AddTicks(2216));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 4, 13, 7, 47, 82, DateTimeKind.Local).AddTicks(5342));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogItemFeature", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 4, 13, 7, 47, 82, DateTimeKind.Local).AddTicks(8807));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 4, 13, 7, 47, 83, DateTimeKind.Local).AddTicks(1301));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 4, 13, 7, 47, 83, DateTimeKind.Local).AddTicks(3925));
