...
namespace Persistence.Migrations
{
    ...
    [Migration("20210506075330_userAddress")]
            ...
            modelBuilder.Entity("Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2021, 5, 6, 12, 23, 29, 76, DateTimeKind.Local).AddTicks(1277));
            ...
            modelBuilder.Entity("Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 6, 12, 23, 29, 94, DateTimeKind.Local).AddTicks(7547));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 6, 12, 23, 29, 95, DateTimeKind.Local).AddTicks(2851));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 6, 12, 23, 29, 95, DateTimeKind.Local).AddTicks(6010));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogItemFeature", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 6, 12, 23, 29, 96, DateTimeKind.Local).AddTicks(2309));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 6, 12, 23, 29, 96, DateTimeKind.Local).AddTicks(6300));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 6, 12, 23, 29, 97, DateTimeKind.Local).AddTicks(1044));
            ...
            modelBuilder.Entity("Domain.Users.UserAddress", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 6, 12, 23, 29, 97, DateTimeKind.Local).AddTicks(3898));
